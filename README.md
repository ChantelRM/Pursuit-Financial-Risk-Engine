...
- **CI/automated retraining** — a GitHub Action to re-run the notebook on push, catching breakage automatically rather than relying on manual "restart and run all" passes. ***test on push as been implemented***
